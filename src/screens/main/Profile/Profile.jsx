...
const data = [
  ...
  { id: 3, icon: AppIcons.my_orders, title: 'My Orders', navTo: '' },
  { id: 4, icon: AppIcons.my_wishlist, title: 'My Wishlist', navTo: 'PaymentMethod' },
  { id: 5, icon: AppIcons.chat_with, title: 'Chat with us', navTo: '' },
  ...
  { id: 9, icon: AppIcons.logout, title: 'Log out', navTo: '' },
];
